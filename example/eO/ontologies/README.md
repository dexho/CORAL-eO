# Ontologies for echusOverlook

This directory contains ontologies customized for users of echusOverlook (eO).

Ontologies we defined:

* context_measurement_ontology = terms and microtypes to describe
  eO data, probably useful for other space systems engineering projects.

* data_type_ontology = terms to describe high level data types in eO
