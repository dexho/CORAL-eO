...
my $uo = $parser->work("/Users/desho/CORAL_old/example/enigma/ontologies/unit_standalone.obo");
my $uo2 = $parser->work("/Users/desho/CORAL_old/example/enigma/ontologies/context_measurement_ontology.obo");
